...
/**
 * @fileoverview Module for the notes page.
 */
...
@NgModule({
  ...
  entryComponents: [NotesPageComponent],
  providers: [
    {
...
class NotesPageModule implements DoBootstrap {
  ngDoBootstrap() {}
}
...
const bootstrapFnAsync = async (extraProviders: StaticProvider[]) => {
  ...
  return platformRef.bootstrapModule(NotesPageModule);
};
