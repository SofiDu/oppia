...
/**
 * @fileoverview Tests for NoteAdminAuthGuard
 */
...
describe('NoteAdminAuthGuard', () => {
  let userService: UserService;
  let router: Router;
  let guard: NoteAdminAuthGuard;
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(NoteAdminAuthGuard);
    userService = TestBed.inject(UserService);
    router = TestBed.inject(Router);
  });

  it('should redirect user to 401 page if user is not note admin', done => {
